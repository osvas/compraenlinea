Feature: Yo como usuario de la tienda Your Logo quiero tener la posibilidad de crear mi cuenta para poder ingresar a la página
  ...
  Scenario: Creación de la cuenta
    ...
    When Creo la cuenta en la página
      ...
      | Mrs    | Oscar  | Vasquez  | anacristina4@gmail.com | 12345      | 25            | November      | 1999          | Sofka    | Avenida siempre viva | Apto 301   | Medellin | Illinois | 53001        | United States | Escenario de prueba | 5854673  | 3104229735 | Calle 21 #19-83  |
